...
class CheckoutController extends GetxController implements GetxService {
  ...
  Future<double?> getDistanceInKM(
      osm.LatLng originLatLng,
      osm.LatLng destinationLatLng,
      ) async {

    _distance = -1;

    try {
      final double distanceInMeter = Geolocator.distanceBetween(
      ...
      _distance = distanceInMeter / 1000; // تحويل إلى كيلومتر
    } catch (e) {
      _distance = 0;
    }

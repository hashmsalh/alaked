              ...
              if(address != null) {
                ...
                if(previousGuestAddress != address.deliveryAddress) {
                  checkoutController.getDistanceInKM(
                    osm.LatLng(double.parse(address.latitude), double.parse(address.longitude)),
                    osm.LatLng(double.parse(checkoutController.store!.latitude!), double.parse(checkoutController.store!.longitude!)),
                  );
                }
              }
            },

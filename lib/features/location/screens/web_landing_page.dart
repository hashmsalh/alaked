                    ...
                    child: Row(children: [
                      Expanded(child: TypeAheadField(
                        ...
                        onSelected: (PredictionModel suggestion) async {
                          ...
                          /// إنشاء AddressModel مباشرة من إحداثيات OSM
                          ...
                          await Get.find<LocationController>().getZone(
                            suggestion.latitude.toString(),
                            suggestion.longitude.toString(),
                            false,
                          );

                          /// تحديث العنوان مع zone
                          _address = AddressModel(
                            address: address.address,
                            latitude: address.latitude,
                            longitude: address.longitude,
                            zoneId: zoneResponse.isSuccess ? zoneResponse.zoneIds.first : 0,

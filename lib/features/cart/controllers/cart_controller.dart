...
class CartController extends GetxController implements GetxService {
  ...
  Future<void> setQuantity(bool isIncrement, int cartIndex, int? stock, int ? quantityLimit) async {
    ...
    _cartList[cartIndex].quantity = await cartServiceInterface.decideItemQuantity(isIncrement, _cartList, cartIndex, stock, quantityLimit,Get.find<SplashController>().configModel?.moduleConfig?.module?.stock ?? false
    );
